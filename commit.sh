...
# web/update/carreUp.php
# web/update/charbonUp.php
# web/update/collectionUp.php
# web/update/decapageUp.php
# web/update/fouilleUp.php
# web/update/galetUp.php
# web/update/gisementUp.php
# web/update/lieuUp.php
# web/update/locusUp.php
# web/update/objetUp.php
# web/update/osUp.php
# web/update/personneUp.php
# web/update/prospectionUp.php
# web/update/regionUp.php
# web/update/silexUp.php
# web/update/siteUp.php
########################################################################################################################################
