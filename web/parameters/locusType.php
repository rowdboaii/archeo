			...
			<section>
				...
				<div id = "">
					...
					<p>
						...
						<form method = "post" action = "../inserts/locusTypeInsert.php">
							<p>
					...
					<!-- Modification d'un Type de Locus. -->
					<h2>Modification</h2>
					<p>
						<!-- Formulaire pour un Type de Locus. -->
						<form method = "post" action = "../exec/locusTypeUpdate.php">
							<p>
					...
					<!-- Suppression d'un Type de Locus. -->
					<h2>Suppression</h2>
					<p>
						<!-- Formulaire pour un Type de Locus. -->
						<form method = "post" action = "../exec/locusTypeDelete.php">
							<p>
