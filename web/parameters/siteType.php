		...
		<div id = "">
			...
			<section>
				...
				<div id = "">
					...
					<!-- Insertion d'un Type de Site. -->
					<h2>Ajout</h2>
					<p>
						<!-- Formulaire pour un Type de Site. -->
						</p><form method = "post" action = "../inserts/siteTypeInsert.php">
							<p>
					...
					<p>
						<!-- Formulaire pour un Type de Site. -->
						<form method = "post" action = "../updates/siteTypeUp.php">
							<p>
					...
					<p>
						<!-- Formulaire pour un Type de Site. -->
						<form method = "post" action = "../exec/siteTypeDelete.php">
							<p>
