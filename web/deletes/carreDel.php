		...
		<div id = "">
			...
			<section>
				...
				<div id = "">
					...
					<p>
						<!-- Formulaire pour le Delete d'un Carré. -->
						<form method = "post" action = "../exec/carreDelete.php">
							<p>
								<label for = "delete">Carré à supprimer</label> :
