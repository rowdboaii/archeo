				...
				<div id = "">
					...
					<?php
						...
						$query = $bdd->prepare('SELECT s.objet, o.nom
									FROM silex s, objet o
									WHERE s.objet = o.identifiant'
									);
					?>

					<p>
						<!-- Formulaire pour le Delete d'un Silex. -->
						<form method = "post" action = "../exec/silexDelete.php">
							<p>
								<label for = "delete">Silex à supprimer</label> :
