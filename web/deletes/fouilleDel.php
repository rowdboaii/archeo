			...
			<section>
				...
				<div id = "">
					...
					<?php
						...
						$query = $bdd->prepare('SELECT f.identifiant, f.nom
									FROM fouille f'
									);
					?>

					<p>
						<!-- Formulaire pour le Delete d'une Fouille. -->
						<form method = "post" action = "../exec/fouilleDelete.php">
							<p>
								<label for = "delete">Fouille à supprimer</label> :
