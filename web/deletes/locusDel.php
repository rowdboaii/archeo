		...
		<div id = "">
			...
			<section>
				...
				<div id = "">
					...
					<p>
						<!-- Formulaire pour le Delete d'un Locus. -->
						<form method = "post" action = "../exec/locusDelete.php">
							<p>
								<label for = "delete">Locus à supprimer</label> : 
