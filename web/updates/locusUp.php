			...
			<section>
				...
				<div id = "">
					...
					<?php
						...
						$query4 = $bdd->prepare('SELECT l.identifiant, l.nom, s.nom AS nom_site, t.type AS nom_type, l.position_nord, l.position_est, l.altitude, f.prenom AS prenom_f, 																			f.nom AS nom_f, p.prenom AS prenom_p, p.nom AS nom_p
