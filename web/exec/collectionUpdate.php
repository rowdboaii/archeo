		...
		<div id = "">
			...
			<section>
				...
				<div id = "">
					...
					<?php
						if (isset($_SESSION['champ']) AND isset($_POST['old']) AND isset($_POST['new'])) {
							...
							if ($_SESSION['champ'] == 'nom') {
								$query = $bdd->prepare('UPDATE collection
											SET nom = :new
											WHERE nom = :old'
											);
							}
							else if ($_SESSION['champ'] == 'proprietaire') {
								$query = $bdd->prepare('UPDATE collection
											SET proprietaire = :new
											WHERE proprietaire = :old'
											);
							}
					...
					<!-- Lien de retour. -->
					<p>
						<a href = "../updates/collectionUp.php">Revenir</a>
					</p>
